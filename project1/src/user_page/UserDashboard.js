...
import JustArriveProduct from './JustArriveProduct'
...
const UserDashboard = () => {
    return (
        <div className='wrapper'>
            ...
            <div className="container-fluid bg-secondary my-5 text-dark">
                <div className="row justify-content-md-center py-5 px-xl-5">
                    <div className="col-md-6 col-12 py-5">
                        <div className="text-center mb-2 pb-2">
                            <h2 className="section-title px-5 mb-3"><span className="bg-secondary px-2 text-dark">Stay Updated</span></h2>
